...
@section('content')
    ...
    <div style="text-align: right" class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="text-center">إضافة وجبة</h1>

        <form action="/admin/meal/store" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input style="text-align: right" type="text" class="form-control" id="ingredients" placeholder="أدخل مكونات الوجبة" name="ingredients" required>
            </div>
