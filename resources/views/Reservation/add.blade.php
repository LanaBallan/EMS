        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <form  action="/user/reserve/store/{{$id}}" method="POST">
                        @csrf

                        <div class="input-group">
                            <input type="date" placeholder="Date" id="date" name="date" class="form-control form-control-user ">
                        </div>
                        <div class="input-group">
                            <input class="input--style-2" type="number" placeholder="Number Of People" name="number_of_people">
                        </div>
