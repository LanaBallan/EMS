                ...
                <div class="grid_3">
                    <div class="card" style="width:200px">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Number: {{$one->number}}</p>
                            <p class="card-text">Location: {{$one->location}}</p>
                            <p class="card-text">Email: {{$one->email}}</p>
                            @guest
                                @if (Route::has('user.login'))
                                    <a href="{{ route('user.login') }}" class="btn btn-primary">Reserve</a>
                                @endif
                            @else
                                <a href="/user/add/reserve/{{$one->id}}" class="btn btn-primary">Reserve</a>
                            @endguest
                        </div>
                    </div>
                </div>
